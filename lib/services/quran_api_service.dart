...
class QuranApiService {
  ...
  static Future<String> fetchTranslation(int surah, int ayah, String languageCode) async {
    ...
    try {
      print('[QuranApiService] fetchTranslation url: $url');
      final response = await http.get(url);
      print('[QuranApiService] fetchTranslation status: ${response.statusCode}');
      ...
      print('[QuranApiService] Error fetching translation ($url): $e\n$st');
  ...
  static Future<String> fetchTranslationByResourceId(int surah, int ayah, int resourceId) async {
    ...
    try {
      print('[QuranApiService] fetchTranslationByResourceId url: $url');
      final response = await http.get(url);
      print('[QuranApiService] fetchTranslationByResourceId status: ${response.statusCode}');
      ...
      print('[QuranApiService] Error fetching translation by resource ID ($url): $e\n$st');
      return 'Error fetching data';
    }
  }
}
